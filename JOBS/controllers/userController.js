...
// Show all jobs created by employeer
...
//Adding controllres methods that are only accesible by admins
...
// Delet user by Admin => api/v1/user/:id
...
async function deleteUserData(user, role) {
    ...
    if (role === 'user') {
        ...
        for (let i = 0; i < appliedJobs.length; i++) {
            ...
            let filepath = `/Users/dariosemino/nodeUdemy/JOBS/public/uploads/${obj.resume}`
